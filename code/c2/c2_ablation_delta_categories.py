...
SEED     = 42
MODEL   = 'mlp'
CV_DIR   = f'/work3/s251710/thesis_results/C2_custom/{DISEASE}/cv_results/cf_{CF_COUNT}'
OUT_DIR  = f'/work3/s251710/thesis_results/ablation_delta/{DISEASE}_cf{CF_COUNT}_{MODEL}'
