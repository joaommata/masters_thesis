...
MANIFEST_PATH = f"{BASE_DIR}/results/diffusion_cf/cf_manifest_50_0.025.csv" ### CHANGED 
OUTPUT_PATH   = f"{BASE_DIR}/results/diffusion_cf/cf_attributes_50_0.025.csv" ### CHANGED 
BATCH_SIZE    = 16
