...
NEW_FEATURE_CLASSES = ['glrlm', 'glszm']  # add/remove as needed
# ─────────────────────────────────────────────────────────────────────────────
...
def extend_split(csv_filename, attribute_csv, data_base, results_base, segmentation_model,
                 batch_size=16, num_workers=12):

    data_path    = os.path.join(data_base, "CheXpert-v1.0-small")
    csv_path     = os.path.join(data_path, csv_filename)
    input_path   = os.path.join(results_base, "C1_attributes", attribute_csv)
    output_path  = os.path.join(results_base, "C1_attributes",
...
def main():
    data_base   = "/work3/s251710/thesis_data"
    results_base = "/work3/s251710/thesis_results"
