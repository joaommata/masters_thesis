...
DATA_PATH      = os.path.join(DATA_ROOT, "CheXpert-v1.0-small")
OUTPUT_DIR     = os.path.join(RESULTS_DIR, "C0_baseline/", TARGET_DISEASE.lower().replace(" ", "_")    )
BATCH_SIZE     = 32
...
class CheXpertDataset(xrv.datasets.CheX_Dataset):
    ...
    def __getitem__(self, idx):
        ...
        img_path = os.path.join(DATA_ROOT, sample["Path"])
